...
- Şirket içindeki müşteri aramalarında yapılan işlem ve söylenen ücret kaydedilir. Yeni işlem `ONAY_BEKLIYOR` durumuyla onay listesine düşer, çift tıklanınca tamamlanır.
...
- WhatsApp oturumu yalnız ortak ayarda seçilen ana bilgisayardadır. İstemciler mesajı `WHATSAPPMESAJLARI` kuyruğuna bırakır. Her ekranın üstünde bağlantı durumu ile oturumun açık olduğu kullanıcı ve bilgisayar görünür.
...
- Kurulum: `dist\Vega Ticket Setup 1.5.0.exe`
